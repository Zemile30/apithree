...
news1 = News(
    "iPhone 16 Pro Max",
    "iPhone 16 Pro Max will feature a larger 6.9-inch display, powered by the A18 Pro chip with enhanced AI capabilities, and will include a new dedicated Capture button for improved camera functionality.",
    "https://github.com/bakueduaz/images/blob/main/iphone_16_pro_max.png?raw=true"
)

news2 = News(
    "Airpods Pro 3",
    "Airpods Pro 3 are expected to feature new adaptive audio technology, improved noise cancellation, and potentially offer new color options.They are still in early development stages.",
